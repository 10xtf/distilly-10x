...
3. Do not compress [system-v3.md](../../../docs/design/system-v3.md) into architecture.md. Edit only the in-force parent design file, then run `python3 scripts/sync_design_chapters.py`; generated chapters are not hand-edited, and deprecated V2/V1 bodies remain historical.
