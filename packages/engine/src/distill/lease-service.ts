...
import { buildBriefingCandidate } from "./briefing-builder.js";
...
/** Concrete fact, projection, lock, and deterministic dependencies for Step 6 leases. */
...
/** Package-internal query and mutation coordinator for pending jobs and durable leases. */
